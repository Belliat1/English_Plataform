              ...
              <div key={level.id} className="flex flex-col gap-4 card-level">
                ...
                <div className="flex flex-col gap-2">
                  {level.modules.map((module) => (
                        ...
                        id={module.id}
                        title={module.title}
                        status={module.status as "completed" | "active" | "locked"} // ✅ Esto forza el tipo literal
                      />             ))}
                </div>
  ...
  levelTitle={level.title as "Principiante" | "Intermedio" | "Avanzado"} // ✅ Esto genera la URL del examen por nivel
>
  Comenzar examen
</ExamButton>
